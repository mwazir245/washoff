...
export const platformContentSeedCatalog: PlatformContentSeedDefinition[] = [
  ...
  defineSeedEntry("landing", "header", "primary_button", "button_label", 30, "زر الإجراء الرئيسي", "Primary action button", "سجّل فندقك الآن", "Register your hotel"),
  defineSeedEntry("landing", "hero", "eyebrow", "section_label", 40, "عنوان تمهيدي", "Hero eyebrow", "حل تشغيلي ذكي مصمم للفنادق والمغاسل", "An operations platform built for hotels and laundries"),
  defineSeedEntry("landing", "hero", "title", "headline", 50, "العنوان الرئيسي", "Hero title", "منصة ذكية لإدارة وتشغيل خدمات الغسيل للفنادق", "A smart platform to run hotel laundry operations"),
  defineSeedEntry("landing", "hero", "highlight", "paragraph", 60, "النص المميز", "Hero highlight", "أوقف إدارة الغسيل اليدوية... ودع النظام يختار أفضل مزود تلقائيًا", "Stop manual laundry coordination and let the system pick the right provider automatically"),
  defineSeedEntry("landing", "hero", "description", "paragraph", 70, "وصف الواجهة", "Hero description", "WashOff تمكّن الفنادق من إرسال طلبات الغسيل ومتابعتها بسهولة، بينما يقوم النظام تلقائيًا باختيار أفضل مزود خدمة بناءً على السعة، الالتزام الزمني، جودة الأداء، والتكلفة - بدون أي تدخل يدوي.", "WashOff helps hotels submit and track laundry orders while the system automatically selects the best provider based on capacity, timeliness, quality, and cost."),
  ...
  defineSeedEntry("landing", "hero", "provider_link", "link_label", 90, "رابط تسجيل المزوّد", "Provider registration link", "سجّل مزود الخدمة", "Register as a provider"),
