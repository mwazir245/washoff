...
export const translations = {
  en: {
    ...
    "donation.step4.desc": "Clothes are delivered to specialized charity organizations",
    ...
    "howItWorksPage.title": "How Wash Off Works",
    ...
    "deliveryRegister.backToHome": "Back to Home",
    "deliveryRegister.title": "Become a Delivery Partner",
    "deliveryRegister.subtitle": "Join our network and earn money delivering fresh laundry",
    "deliveryRegister.cardTitle": "Partner Registration",
    "deliveryRegister.cardDesc": "Fill in your details to get started",
    "deliveryRegister.partnerType": "Partner Type",
    "deliveryRegister.individual": "Individual",
    "deliveryRegister.individualDesc": "Personal driver",
    "deliveryRegister.company": "Company",
    "deliveryRegister.companyDesc": "Delivery company",
    "deliveryRegister.fullName": "Full Name",
    "deliveryRegister.fullNamePlaceholder": "Enter your full name",
    "deliveryRegister.email": "Email",
    "deliveryRegister.emailPlaceholder": "Enter your email",
    "deliveryRegister.phone": "Phone Number",
    "deliveryRegister.phonePlaceholder": "Enter your phone number",
    "deliveryRegister.city": "City",
    "deliveryRegister.cityPlaceholder": "Enter your city",
    "deliveryRegister.companyName": "Company Name",
    "deliveryRegister.companyNamePlaceholder": "Enter company name",
    "deliveryRegister.submitting": "Submitting...",
    "deliveryRegister.submitApplication": "Submit Application",
    "deliveryRegister.earnMore": "Earn More",
    "deliveryRegister.flexibleHours": "Flexible Hours",
    "deliveryRegister.workLocally": "Work Locally",
  },
  ar: {
    // Common
    "app.name": "واش أوف",
    ...
    "donation.step4.desc": "تسلم للجمعيات المختصة",
    ...
    "howItWorksPage.title": "كيف يعمل واش أوف",
    ...
    // Delivery Register Page
    "deliveryRegister.backToHome": "العودة للرئيسية",
    "deliveryRegister.title": "كن شريك توصيل",
    "deliveryRegister.subtitle": "انضم إلى شبكتنا واكسب المال من توصيل الغسيل النظيف",
    "deliveryRegister.cardTitle": "تسجيل الشريك",
    "deliveryRegister.cardDesc": "املأ بياناتك للبدء",
    "deliveryRegister.partnerType": "نوع الشريك",
    "deliveryRegister.individual": "فرد",
    "deliveryRegister.individualDesc": "سائق شخصي",
    "deliveryRegister.company": "شركة",
    "deliveryRegister.companyDesc": "شركة توصيل",
    "deliveryRegister.fullName": "الاسم الكامل",
    "deliveryRegister.fullNamePlaceholder": "أدخل اسمك الكامل",
    "deliveryRegister.email": "البريد الإلكتروني",
    "deliveryRegister.emailPlaceholder": "أدخل بريدك الإلكتروني",
    "deliveryRegister.phone": "رقم الهاتف",
    "deliveryRegister.phonePlaceholder": "أدخل رقم هاتفك",
    "deliveryRegister.city": "المدينة",
    "deliveryRegister.cityPlaceholder": "أدخل مدينتك",
    "deliveryRegister.companyName": "اسم الشركة",
    "deliveryRegister.companyNamePlaceholder": "أدخل اسم الشركة",
    "deliveryRegister.submitting": "جاري الإرسال...",
    "deliveryRegister.submitApplication": "إرسال الطلب",
    "deliveryRegister.earnMore": "اكسب أكثر",
    "deliveryRegister.flexibleHours": "ساعات مرنة",
    "deliveryRegister.workLocally": "اعمل محلياً",
  },
};
